  ...
  steps {
   ...
   stage('Check code coverage') {
      ...
      steps {
          ...
          sh 'docker build -t mhsedky/restaurant-listing-service:${VERSION} .'
          sh 'docker push mhsedky/restaurant-listing-service:${VERSION}'
      }
    } 
    ...
    stage('Update Image Tag in GitOps') {
      steps {
        ...
        script {
       sh '''
          sed -i "s/image:.*/image: mhsedky\\/restaurant-listing-service:${VERSION}/" aws/restaurant-manifest.yml
        '''
